...
var Validator = (function () {
    ...
    |
    */
    Validator.prototype._generateTaxRegionCodes = function () {
        if (this._taxRegionCodes) {
            return;
        }
        var toReturn = [];
        for (var i = 2, j = 20; i <= j; ++i) {
            var temp = i.toString().length < 2 ? '0' + i.toString() : i.toString();
            toReturn.push(temp, (i + 20).toString());
        }
        for (var i = 41, j = 44; i <= j; ++i) {
    ...
    | @return array
    */
    Validator.prototype.getRegionCodes = function () {
    ...
    |
    */
    Validator.prototype._isTaxRegion = function (val) {
    ...
    */
    ...
    |
    */
    Validator.prototype._getInfo = function (taxnumber) {
        ...
        if (parts[5]) {
            ...
            var r = +toReturn.region > 20 && +toReturn.region <= 40 ?
                +toReturn.region - 20 :
                +toReturn.region;
    ...
    |
    */
    Validator.prototype._getError = function (b) {
        var toReturn = { valid: false, errors: [] };
        for (var n = 0; n < b.length; n++) {
            // Hibaüzenet lekérdezése
            var item = this._messages[n];
            if (b[n]) {
    ...
    */
    ...
    |
    */
    Validator.prototype.check = function (taxnumber) {
        // Csak egyser fut le
        this._generateTaxRegionCodes();
        if (!taxnumber) {
            return false;
